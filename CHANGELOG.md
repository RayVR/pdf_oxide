...
> Press-accurate CMYK→RGB on the composite render path via the document `/OutputIntents` ICC profile; vertical writing mode (WMode 1 / tategaki) support across extraction, rendering, and reading-order pipelines
